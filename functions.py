    ...
    for _ in range(1, number + 1):
        ...
        for _ in range(1, 3):
            ...
            for _ in range(5):
                ...
                if chance >= 75:
                    thing = THING_LIBRARY[
                        random.randint(1, len(THING_LIBRARY.keys()))
                    ]
...
def fight_table(fighters_list):
    ...
    if len(new_fighter_list_1) > 2:
        ...
        if fighter_1.health > 0:
            print(Fore.YELLOW + f'{fighter_1.name_class} '
                                f'{fighter_1.name} - Герой Арены!')
            return fighter_1
        if fighter_2.health > 0:
            print(Fore.YELLOW + f'{fighter_2.name_class} '
                                f'{fighter_2.name} - Герой Арены!')
            return fighter_2
