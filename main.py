...
class Paladin(Person):
    ...
    def equip(self, equipment: list[Dagger, Sword, Chest, Shield]) -> dict:
...
class Warrior(Person):
    ...
    def equip(self, equipment: list):
        ...
        return {'hp': self.hp * Warrior.hp_bonus, 'armor': self.armor,
                'damage': self.damage, 'block_chance': self.block_chance,
                'ignore_armor': self.ignore_armor, 'crit_chance': self.crit_chance
                }
...
class Arena:
    ...
    def __init__(self, equipments: list[Any(Dagger, Sword, Chest, Shield)], characters: list[Any(Warrior, Rogue, Paladin)]):
    ...
    def fait(self) -> None:
        ...
        while self.characters[0].hp >= 0 or self.characters[1].hp >= 0:
            ...
            self.characters[0].hp = self.characters[0].hp - \
                                    (self.characters[1].damage - self.characters[1].damage * self.characters[0].armor)
