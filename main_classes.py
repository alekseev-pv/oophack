...
class Warrior(Person):
    def __init__(self, name, inventory):
        ...
        self.bonus_damage = (sum(thing.bonus_attack for thing in inventory)
                             + 100) / 100
        self.bonus_defense = (sum(thing.bonus_defense for thing in inventory)
                              + 100) / 100
        self.bonus_health = (sum(thing.bonus_health for thing in inventory)
                             + 100) / 100
        self.bonus_dodge = (sum(thing.bonus_dodge for thing in inventory)
                            + 100) / 100
        self.bonus_block = (sum(thing.bonus_block for thing in inventory)
                            + 100) / 100
