...
def start(update: Update, context: CallbackContext) -> int:
    ...
    keyboard = [
        [
            InlineKeyboardButton("Симуляция", callback_data=str(ONE)),
        ],
        [
            InlineKeyboardButton("Принять участие в битве",
    ...
    update.message.reply_text(
        "Добро пожалость на битву!Выберите вариант игры", reply_markup=reply_markup)
...
def main() -> None:
    ...
    updater = Updater("1918981179:AAHjEcNMBS086FuecIEZYQIsmojjSal1zKE")
